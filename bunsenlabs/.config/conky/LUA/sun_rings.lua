...
gauge = {
{
    ...
    graph_fg_colour=0xE2DEDE,      graph_fg_alpha=0.6,
    hand_fg_colour=0x343041,      hand_fg_alpha=0.1,
    --hand_fg_colour=0xEF5A29,       hand_fg_alpha=0.1,
    txt_radius=64,
    txt_weight=0,                  txt_size=9.0,
    txt_fg_colour=0x68364B,        txt_fg_alpha=0,
    --txt_fg_colour=0xEF5A29,        txt_fg_alpha=0,
    graduation_radius=28,
    graduation_thickness=0,        graduation_mark_thickness=1,
    graduation_unit_angle=27,
    graduation_fg_colour=0x343041, graduation_fg_alpha=0.3,
    caption='',
    caption_weight=1,              caption_size=9.0,
    caption_fg_colour=0x343041,    caption_fg_alpha=0.3,
},
{
...
},
{
    ...
    graduation_unit_angle=27,
    graduation_fg_colour=0x343041, graduation_fg_alpha=0.5,
    caption='',
    caption_weight=1,              caption_size=10.0,
    caption_fg_colour=0x343041,    caption_fg_alpha=0.3,
},
{
    name='fs_used_perc',           arg='/media/che/data',                     max_value=100,
    x=100,                          y=470,
    graph_radius=54,
    graph_thickness=7,
    graph_start_angle=180,
    ...
    caption_fg_colour=0xE2DEDE,    caption_fg_alpha=0.6,
},
{
